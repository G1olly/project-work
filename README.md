...
- presentare sinteticamente l’azienda;
- mostrare alcuni dati e informazioni significative;
- raccogliere contenuti visivi;
...
- migliorare l’accessibilità ai report di sostenibilità;
- organizzare i contenuti secondo una struttura chiara e intuitiva;
...
project-work/
│
├── images/        # immagini utilizzate nel progetto
├── reports/       # report PDF scaricabili
